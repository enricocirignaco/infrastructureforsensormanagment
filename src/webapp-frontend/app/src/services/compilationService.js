...
export default {
    ...
    getBuildArtifact: function(jobId, getBinaryOnly, getSourceCode, getLogs) {
        let url = BASE_URL + '/compilation/job/' + jobId + '/artifacts?' + getBinaryOnly + '&' + getSourceCode + '&' + getLogs
        const options = {
            method: 'GET',
            headers: {
                ...authStore.getAuthHeader(),
